								...
								<div class="modal-content">
									...
									<form class="form-horizontal" id="sample-form">
										<div class="modal-body">
											<div class="center">
												...
												<div class="form-group has-info">
													...
													<div class="col-xs-12 col-sm-5">
														<span class="block input-icon input-icon-right"> <input
															type="text" id="new-album-title" placeholder="活動標題"
															class="width-100"> <!-- <i
												...
												<div class="form-group has-info">
													...
													<div class="col-xs-12 col-sm-5">
														<span class="block input-icon input-icon-right"> <input
															type="date" id="new-album-date" class="form-control"
										...
										<div class="modal-footer wizard-actions">
											<button id="new-btn-success" class="btn btn-success btn-sm btn-next" type="submit"
												data-last="Finish">
												<i class="ace-icon fa fa-check bigger-110"></i>確定
											</button>

											<button id="new-btn-cancel" class="btn btn-danger btn-sm" data-dismiss="modal">
...
<![endif]-->
		...
		<script>
			...
			/* 新增 */
			$('#simple-table').on('click', '#new-album-success', function(event) {
