...
<![endif]-->
	...
	<script>
		...
		function renderGallery(data) {
			...
			$("#_gallery").empty();
			photoBox = '<form action="../UploadServlet" method="post" enctype="multipart/form-data" class="dropzone" id="dropzone">'
					+ '<div class="fallback"><input type="file" name="filename" multiple="" /></div>'
					+ '<input type="text" id="passAlbumId" name="passAlbumId" value="1234" class="hide"></form>';
			photoBox = '<li><i class="ace-icon fa fa-cloud-upload bigger-110"><br>新增相片</i></li>';

			photoBox = '<li><span class="smaller-80 grey">上傳圖片</span>\
			<i class="upload-icon ace-icon fa fa-cloud-upload blue fa-150x"></i></li>';
			$
					.each(
							list,
							function(index, item) {
